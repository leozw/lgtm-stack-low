...
resource "null_resource" "helmfile_update" {
  ...
  provisioner "local-exec" {
    ...
    sed -i "s|arn:aws:iam::123456789012:role/loki-role-arn|$IAM_LOKI_ARN|" ../helmfile.yaml
    ...
    sed -i "s|arn:aws:iam::123456789012:role/mimir-role-arn|$IAM_MIMIR_ARN|" ../helmfile.yaml
    ...
    sed -i "s|arn:aws:iam::123456789012:role/tempo-role-arn|$IAM_TEMPO_ARN|" ../helmfile.yaml
